...
public class NativeBridge implements EventObserver {
    ...
    public void handleEvent(String event, Map payload) {
        unsafeEval("window.native.events.emit(\"" + safeName(event) + "\", " + safeValue(payload) + ")");
    }
